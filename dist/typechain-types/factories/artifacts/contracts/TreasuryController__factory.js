...
exports.TreasuryController__factory = void 0;
...
const _abi = [
  {
    inputs: [
      ...
      {
        internalType: "address",
        name: "_treasurySigner",
        type: "address",
      },
      {
        internalType: "uint256",
        name: "_requestExpiration",
        type: "uint256",
      },
    ],
  ...
  {
    inputs: [],
    name: "ASIA_FLEX_TOKEN",
    outputs: [
      {
        internalType: "contract IAsiaFlexToken",
        name: "",
        type: "address",
      },
    ],
...
class TreasuryController__factory extends ethers_1.ContractFactory {
  constructor(...args) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  getDeployTransaction(_asiaFlexToken, _treasurySigner, _requestExpiration, overrides) {
    return super.getDeployTransaction(_asiaFlexToken, _treasurySigner, _requestExpiration, overrides || {});
  }
  deploy(_asiaFlexToken, _treasurySigner, _requestExpiration, overrides) {
    return super.deploy(_asiaFlexToken, _treasurySigner, _requestExpiration, overrides || {});
  }
  connect(runner) {
...
exports.TreasuryController__factory = TreasuryController__factory;
TreasuryController__factory.bytecode = _bytecode;
TreasuryController__factory.abi = _abi;

...
exports.BasketToken__factory = void 0;
...
class BasketToken__factory extends ethers_1.ContractFactory {
  constructor(...args) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  getDeployTransaction(name_, symbol_, manager, overrides) {
    return super.getDeployTransaction(name_, symbol_, manager, overrides || {});
  }
  deploy(name_, symbol_, manager, overrides) {
    return super.deploy(name_, symbol_, manager, overrides || {});
  }
  connect(runner) {
...
exports.BasketToken__factory = BasketToken__factory;
BasketToken__factory.bytecode = _bytecode;
BasketToken__factory.abi = _abi;

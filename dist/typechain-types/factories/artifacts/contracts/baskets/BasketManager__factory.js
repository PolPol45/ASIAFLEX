...
exports.BasketManager__factory = void 0;
...
const _abi = [
    ...
    outputs: [
      {
        ...
        internalType: "struct BasketManager.WeightedAsset[]",
        name: "",
        type: "tuple[]",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct BasketManager.BasketConfig",
        name: "",
        type: "tuple",
      },
    ],
  ...
  },
  {
    inputs: [
      {
        internalType: "enum BasketManager.Region",
        name: "region",
        type: "uint8",
      },
      {
        internalType: "enum BasketManager.Strategy",
        name: "strategy",
        type: "uint8",
      },
    ],
    ...
    outputs: [
      {
        components: [
          {
            internalType: "contract BasketToken",
            name: "token",
            type: "address",
          },
          {
        ...
        internalType: "struct BasketManager.BasketState",
        name: "",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IMedianOracle",
        name: "",
        type: "address",
      },
    ],
...
class BasketManager__factory extends ethers_1.ContractFactory {
  constructor(...args) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  getDeployTransaction(admin, adminDelay, baseAssetAddress, priceOracleAddress, overrides) {
    return super.getDeployTransaction(admin, adminDelay, baseAssetAddress, priceOracleAddress, overrides || {});
  }
  deploy(admin, adminDelay, baseAssetAddress, priceOracleAddress, overrides) {
    return super.deploy(admin, adminDelay, baseAssetAddress, priceOracleAddress, overrides || {});
  }
  connect(runner) {
...
exports.BasketManager__factory = BasketManager__factory;
BasketManager__factory.bytecode = _bytecode;
BasketManager__factory.abi = _abi;
